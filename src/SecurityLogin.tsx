...
//     // Assuming that login returns a Promise indicating success or failure
//     // You can modify this logic based on the actual behavior of `login` function
//     login(username, password).then((success: any) => {
//       if (currentUser === "Administrator") {
//         navigate("/WelcomePage"); // Navigate on successful login
//       }
//     });
//   };
